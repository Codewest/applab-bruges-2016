...
var toggleMenu = function() {
    console.log("menustatus: " + menuOpen + " submenustatus: " + subMenuOpen);
    if (menuOpen) {
        if(subMenuOpen) {
            console.log("Im in the submenutrue");
            $(".interesses-page").slideUp();
            $(".main-menu").slideDown();
            subMenuOpen = false;
        } else {
            console.log("Im in the menuopenelse");
